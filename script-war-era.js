...
const countriesDatabase = {
    ...
    bs: { name: "Bahamas", color: "#00AEC7", url: "" },
    bb: { name: "Barbados", color: "#00267F", url: "" },
    bz: { name: "Belize", color: "#003F87", url: "" },
    ...
    co: { name: "Colômbia", color: "#FCD116", url: "" },
    cr: { name: "Costa Rica", color: "#002F6C", url: "" },
    ...
    ht: { name: "Haiti", color: "#00209F", url: "" },
    ...
    lv: { name: "Letônia", color: "#9E3039", url: "" },
    ...
    gw: { name: "Guiné-Bissau", color: "#C61026", url: "" },
    ...
    ph: { name: "Filipinas", color: "#0038A8", url: "" },
